...
class Movie(models.Model):
    ...
    budget = models.PositiveIntegerField('Бюджет', default=0, help_text='указываем сумму в долларах')
    fees_in_usa = models.PositiveIntegerField('Сборы в США', default=0, help_text='указываем сумму в долларах')
    fees_in_world = models.PositiveIntegerField(
        'Сборы в мире', default=0, help_text='указываем сумму в долларах')
